...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'st_delivery' => 'status',
        'uf_delivery' => 'estados',
        'dt_init_delivery' => 'data previsão entrega inicial',
        'dt_end_delivery' => 'data previsão entrega final',
        'dt_init_forecast' => 'data liberação inicial',
        'dt_end_forecast' => 'data liberação final',
    ],
];
